package kz.net.book_management.utils;
...
public class RND {
     ...
     *
     * @param length the length of generate string
     * @return generated string
     */
    public static String strInt(int length) {
    ...
    public static String getRandomNumber(){
        List<String> phoneNumbers = List.of("7077675303", "7789115835");
